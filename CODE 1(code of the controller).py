...
cap = cv2.VideoCapture("input_video(CODE1).avi")
...
vid_writer = cv2.VideoWriter('output_video(CODE1).avi',cv2.VideoWriter_fourcc('M','J','P','G'), 10, (frame.shape[1],frame.shape[0]))
